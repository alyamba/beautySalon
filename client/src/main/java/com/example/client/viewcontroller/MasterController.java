...
public class MasterController {
    ...
    void masterControl(ActionEvent event) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(SignInController.class.getResource("masterControl.fxml"));
    ...
    void serviceControl(ActionEvent event) throws IOException{
        ...
        FXMLLoader loader = new FXMLLoader(SignInController.class.getResource("serviceControl.fxml"));
    ...
    void userControl(ActionEvent event) throws IOException{
        ...
        FXMLLoader loader = new FXMLLoader(SignInController.class.getResource("showUsers.fxml"));
